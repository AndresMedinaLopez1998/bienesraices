<?php 
    ...
    // Implemnetar un método para obtener todas las propiedades
            ...
            <tbody>
                <?php foreach( $propiedades as $propiedad ) : ?>
                    <tr>
                        ...
                        <td> <img src="/imagenes/<?php echo $propiedad->imagen ?>" alt="Imagen de la base de datos" class="imagen-tabla"> </td>
